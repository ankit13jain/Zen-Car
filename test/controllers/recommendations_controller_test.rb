...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post recommendations_url, params: { recommendation: { manufacturer: @recommendation.manufacturer, model: @recommendation.model, style: @recommendation.style } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { manufacturer: @recommendation.manufacturer, model: @recommendation.model, style: @recommendation.style } }
